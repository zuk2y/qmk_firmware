...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* Qwerty */
  [_QWERTY] = LAYOUT( \
    KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_MHEN,                        KC_HENK, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, \
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_APP,           LOWER,   KC_LSFT, KC_LCTL,       KC_ENT, KC_SPC,  RAISE,            KC_RBRC, KC_BSLS, KC_EQL,  KC_JYEN  \
  ),

  /* Lower */
  [_LOWER] = LAYOUT( \
    KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______,                        _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PEQL, \
