...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( \
    ...
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,                        KC_DEL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, \
    KC_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,                        KC_HENK, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F12,  \
    _______, _______, _______, KC_PSCR,          _______, _______, _______,       KC_MHEN,KC_HENK, _______,          _______, _______, _______, _______  \
  ),

  /* Raise */
  [_RAISE] = LAYOUT( \
    _______, _______, _______, _______, _______, _______, _______,                        _______, _______, _______, KC_UP,   _______, _______, _______, \
    KC_GRV,  _______, _______, _______, _______, _______, _______,                        KC_DEL,  _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______,                        KC_HENK, _______, KC_HOME, KC_END,  KC_PGUP, KC_PGDN, _______, \
    _______, _______, _______, KC_PSCR,          _______, _______, _______,       KC_MHEN,KC_HENK, _______,          _______, _______, _______, _______  \
    ),
